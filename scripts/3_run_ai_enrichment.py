...
Requer:
  ...
  - Proposicoes ja carregadas no banco (2_run_pipeline.py)

Uso:
  python scripts/3_run_ai_enrichment.py
  python scripts/3_run_ai_enrichment.py --limite 50     # limita por etapa
  python scripts/3_run_ai_enrichment.py --apenas-embed
  python scripts/3_run_ai_enrichment.py --apenas-classifica
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--limite", type=int, default=None,
                   help="Maximo de proposicoes por etapa (default: sem limite — processa tudo)")
