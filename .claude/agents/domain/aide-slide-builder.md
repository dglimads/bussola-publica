...
## File Naming Convention (Bússola Pública)

Slide decks para o projeto Bússola Pública ficam diretamente em `presentation/`:

| Tipo | Naming | Exemplo |
|------|--------|---------|
| Arquitetura / como foi construído | `p{N}-{slug}.html` | `presentation/p1-arquitetura.html` |
| Resultados / insights dos dados | `p{N}-{slug}.html` | `presentation/p2-resultados.html` |
| Apresentações avulsas | `{slug}.html` | `presentation/ceap-analise.html` |

**Paleta obrigatória:** Use a paleta **Semana** (black/silver/blue, `--accent:#4a9eff`) já presente em `presentation/d1-ingest.html` como referência de CSS e SlideEngine JS.  
**Referência de design:** Copie o bloco `<style>` e o `<script>` (SlideEngine) de `presentation/p1-arquitetura.html` — está limpo e validado para o projeto.

**Decks existentes como referência:**
- `presentation/p1-arquitetura.html` — arquitetura do pipeline (15 slides)
- `presentation/p2-resultados.html` — insights dos dados (13 slides)
